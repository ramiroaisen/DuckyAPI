...
const core_1 = __webpack_require__(49);
const swagger_1 = __webpack_require__(0);
const helmet_1 = __importDefault(__webpack_require__(105));
...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        app.useGlobalPipes(new common_1.ValidationPipe({
            ...
            exceptionFactory: (errors) => new common_1.BadRequestException(errors, 'ValidationError'),
        }));
        ...
        swagger_1.SwaggerModule.setup(`${config.get('BASE_URL')}/swagger`, app, document, {
            swaggerOptions: {
